...
rem All project SDKs live under G:\AI\Doom64-RT\deps (never Program Files)
rem Matching fork for gzdoom-rt (sultim-t/RayTracedGL1 doom/hl1 branches are too old)
set "RTGL1_SDK_PATH=G:\AI\Doom64-RT\deps\RTGL"
if not exist "%RTGL1_SDK_PATH%\Include\RTGL1\RTGL1.h" (
  echo ERROR: RTGL1 headers missing at %RTGL1_SDK_PATH%\Include
  echo Clone https://github.com/vs-shirokii/RTGL into G:\AI\Doom64-RT\deps\RTGL
  exit /b 1
)
echo RTGL1_SDK_PATH=%RTGL1_SDK_PATH%

set "ROOT=G:\AI\Doom64-RT\sourcecode\gzdoom-rt"
...
set "REL=G:\AI\Doom64-RT\gzdoom-rt-1.0.2"
