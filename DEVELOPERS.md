...
| …the outlines behind it | [`docs/rt-volumetric-edge-outlines.md`](docs/rt-volumetric-edge-outlines.md) | The README's first known issue, reproduced on MAP93 and **measured**: the dark line at every edge seen through a medium is drawn by the **temporal upscaler**, not by the froxel grid. Six volumetric knobs ruled out by test, including the two this repo previously blamed. |
