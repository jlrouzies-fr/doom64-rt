...
**State (2026-08-17, second pass): the FULL INPUT CONTRACT is implemented, awaiting the
in-game A/B.** The launcher still defaults to A-SVGF (`rt_rayreconstr 0`) until the
verdict is in.
